...
<body id="page-top">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <button type="button" class="btn btn-info" onclick="fetchStudents()">Select</button>
        </div>
    </div>
</div>
...
<script>
    function fetchStudents() {
        var classId = document.getElementById("attendance-class").value;
        var date = document.getElementById("attendance-date").value;

        // Fetch students associated with the selected class from the students table
        <?php
        // Database connection parameters
        $servername = "localhost";
        $username = "your_username";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "students += '<tr><td colspan=\"5\">No students found</td></tr>';";
        }

        echo "document.getElementById('attendance-table').getElementsByTagName('tbody')[0].innerHTML = students;";
        $conn->close();
        ?>
    }
</script>
